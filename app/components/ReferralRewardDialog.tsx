          ...
          <>
            <DialogHeader className="flex flex-col gap-4 text-left sm:text-left">
              ...
              <DialogDescription className="sr-only">
                How the BellaAI referral program works and what activity is
              ...
              <ul className="flex list-disc flex-col gap-2 px-5">
                <li>
                  <span className="text-muted-foreground text-sm">
                    Referral links are available to paid BellaAI customers and
                ...
                <li>
                  <span className="text-muted-foreground text-sm">
                    ...
                    and subscribes to any paid BellaAI plan. No credit is
