...
interface CustomizeBellaAIDialogProps {
  open: boolean;
...
export const CustomizeBellaAIDialog = ({
  open,
  onOpenChange,
}: CustomizeBellaAIDialogProps) => {
        ...
        <div className="flex-1 overflow-y-auto pb-3">
          <div className="space-y-5 pb-3">
            ...
            <div className="flex flex-col gap-2 px-1">
              <Label htmlFor="nickname">What should BellaAI call you?</Label>
              <TextareaAutosize
                id="nickname"
            ...
            <div className="flex flex-col gap-2 px-1">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <Label className="sm:flex-shrink-0">
                  What personality should BellaAI have?
                </Label>
            ...
            {/* Traits */}
            <div className="flex flex-col gap-2 px-1">
              <Label>What traits should BellaAI have?</Label>
            ...
            <div className="flex flex-col gap-3 px-1">
              <Label htmlFor="additional-info">
                Anything else BellaAI should know about you?
              </Label>
              <TextareaAutosize
                id="additional-info"
