    ...
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-label="Set up BellaAI Desktop for Agent mode"
          title="Set up BellaAI Desktop"
        ...
        <div className="space-y-3 p-3">
          ...
          {isMobilePlatform ? (
            <p className="text-xs text-muted-foreground">
              ...
              <span translate="no">BellaAI Desktop</span> for macOS, Windows, or
              Linux.
            </p>
          ) : (
            <Button asChild size="sm" className="w-full">
              ...
              >
                Download <span translate="no">BellaAI Desktop</span>
              </a>
            </Button>
          )}
        </div>
