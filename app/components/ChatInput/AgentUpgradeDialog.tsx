          ...
          <DialogDescription>
            {isDesktopEnvironment
              ? desktopBridgeStatus === "failed"
                ? "BellaAI Desktop is open, but its local sandbox could not connect."
                : desktopBridgeStatus === "connected"
                  ? "BellaAI Desktop is connected and ready for local Agent mode."
                  : "BellaAI Desktop is connecting its local sandbox."
