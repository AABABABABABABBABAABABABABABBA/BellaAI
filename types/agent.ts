...
export const getAgentToolApprovalPromptTitle = ({
  ...
  if (operation === "terminal_execute") {
    return "Allow BellaAI to run this terminal command?";
  }
  if (operation === "terminal_interact") {
    return "Allow BellaAI to interact with this terminal session?";
  }
  if (operation === "file_write") {
    return "Allow BellaAI to create this file?";
  }
  if (operation === "file_append") {
    return "Allow BellaAI to append to this file?";
  }
  if (operation === "file_edit") {
    return "Allow BellaAI to edit this file?";
  }
  return fallback;
};
