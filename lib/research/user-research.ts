...
const USER_PROFILE_SYSTEM_PROMPT = `You are BellaAI's internal product-research analyst. Infer how a user employs BellaAI from privacy-minimized conversation excerpts.
...
const COHORT_SYSTEM_PROMPT = `You are BellaAI's internal product-research lead. Synthesize privacy-safe user profiles into evidence-backed customer avatars and answer the supplied research question.
